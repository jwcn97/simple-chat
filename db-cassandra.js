...
// independently — same trick as the Postgres db.js.
...
// in. No cross-table transaction; same "the write is durable, everything
// downstream is best-effort" philosophy as the Postgres gateway.
...
// only ever gets a row for the recipient, never the sender, so (unlike the
// Postgres version) there's no need to filter out the user's own messages —
// the fan-out write already encodes exactly what should come back.
//
